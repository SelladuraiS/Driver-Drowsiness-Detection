...
predictor = dlib.shape_predictor('C:/Users/Selladurai S/Downloads/project driver/project driver/Driver-Drowsiness-and-Monitoring-System/data.shape_predictor_68_face_landmarks-main/shape_predictor_68_face_landmarks.dat')
...
# Calculate average nose distance for better detection
for i in range(75):
    frame = vs.read()
...
while True:
    ...
    for rect in rects:
        ...
        if count > COUNT_FRAMES:
            ...
            cv2.putText(frame, "Head Bending!", (140, 300), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)
            pygame.mixer.music.load("C:/Users/Selladurai S/Downloads/project driver/project driver/Driver-Drowsiness-and-Monitoring-System/MP3.wav")
            pygame.mixer.music.play()

        elif count1 > COUNT_FRAMES:
            cv2.putText(frame, "DROWSINESS ALERT!", (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)
            cv2.putText(frame, "Yawning!", (290, 300), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)
            pygame.mixer.music.load("C:/Users/Selladurai S/Downloads/project driver/project driver/Driver-Drowsiness-and-Monitoring-System/MP3.wav")
            pygame.mixer.music.play()
        ...
        if ear < EYE_AR_THRESH:
            ...
            if COUNTER >= EYE_AR_CONSEC_FRAMES:
                cv2.putText(frame, "Eye Closed!", (10, 300), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)
                cv2.putText(frame, "DROWSINESS ALERT!", (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)
                pygame.mixer.music.load("C:/Users/Selladurai S/Downloads/project driver/project driver/Driver-Drowsiness-and-Monitoring-System/MP3.wav")
                pygame.mixer.music.play()
        else:
